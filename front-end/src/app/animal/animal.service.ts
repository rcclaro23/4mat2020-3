...
export class AnimalService {
    ...
    private apiUri = this.server + 'animal'
    
    constructor(private http : HttpClient) { }

    listar(){
        return this.http.get(this.server + 'animal').toPromise()
    }

    excluir(id : string) {
        return this.http.request('DELETE', this.server + 'animal', {body: {_id: id}}).toPromise()
    }
