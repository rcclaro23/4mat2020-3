...
controller.novo = async (req, res) => {
    try{
        ...
        await Secretaria.create(req.body)
        // HTTP 201: Created
        res.status(201).end()
    }
    catch(erro){
...
controller.listar = async (req, res) => {
    ...
    let dados = await Secretaria.find()
...
controller.obterUm =async(req, res) => {
    ...
    let obj = await Secretaria.findById(id)
...
controller.atualizar = async (req, res) => {
    ...
    let obj = await Secretaria.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try{
        ...
        const id = req.body._id
        let obj = await Secretaria.findByIdAndDelete(id)
